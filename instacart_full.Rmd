...
best_rf_pred_code <- ifelse(best_rf_pred >= 0.5, 1, 0)

table(test$purpose, best_rf_pred_code)/1310*100
```
...
roc_optim_rand_forest <- roc(test$purpose ~ best_rf_pred, plot = TRUE, print.auc = TRUE, main = "ROC Curve - Optimized Random Forest")
```
